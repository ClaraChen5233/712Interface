...
def confirm_checkbox(process_tweets,tweets,tokenize,df_train,df_column):
    if process_tweets:
...
if uploaded_file is not None:
    ...
    if df_column !='':
        ...
        if st.session_state.processed:
            message, dataFrame.df_train= confirm_checkbox(process_tweets,tweets,tokenize,dataFrame.df_train,df_column)
